...
RUN apt-get update && apt-get install -y --no-install-recommends \
    ...
    libpcre3-dev \
    zlib1g-dev \
    libssl-dev     && apt-get install -y --no-install-recommends wget curl luarocks build-essential libtool     && luarocks install lua-resty-redis     && rm -rf /var/lib/apt/lists/*
